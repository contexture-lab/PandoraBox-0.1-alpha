        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12" id="mapbox">
                <div id="style-selector-control" class="map-control">
                    ...
                    <button onclick="toggleTypeMap('terrain')" class="btn btn-default3" title="<?=$locale['relief'];?>"><i class="fa fa-area-chart" aria-hidden="true"></i></button>
                    &nbsp;&nbsp;&nbsp;<strong><i class="fa fa-university" aria-hidden="true" title="<?=$locale['objects'];?>"></i>:</strong>&nbsp;
                    <input type="radio" name="show-hide" id="hide-poi" class="selector-control">
                    <label for="hide-poi"><i class="fa fa-eye-slash" aria-hidden="true" title="<?=$locale['hide'];?>"></i></label>&nbsp;
                    <input type="radio" name="show-hide" id="show-poi" class="selector-control" checked="checked">
                    <label for="show-poi"><i class="fa fa-eye" aria-hidden="true" title="<?=$locale['show'];?>"></i></label>
                </div>
                <div id="map"></div>
                <div id="menubox">
                    ...
                    <div id="idHome" class="panel panel-default">
                       <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <?=$locale['use_the_menu_commands_to_control_the_system_and_the_performers'];?> <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                        </div>
                    </div>
